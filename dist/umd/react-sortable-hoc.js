...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SortableElement2 = __webpack_require__(119);

	var _SortableElement3 = _interopRequireDefault(_SortableElement2);

	var _SortableHandle2 = __webpack_require__(120);
	...
	var Manager = function () {
		...
		(0, _createClass3.default)(Manager, [{
			...
			value: function getActive() {
				...
				return (0, _lodash.find)(this.refs[this.active.collection], function (_ref) {
					var node = _ref.node;
			...
			value: function getOrderedRefs() {
				...
				return (0, _lodash.sortBy)(this.refs[collection], function (_ref2) {
					var node = _ref2.node;
